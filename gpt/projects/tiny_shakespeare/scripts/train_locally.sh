...
PYTHONPATH=.  pipenv run python gpt/projects/tiny_shakespeare/train_tool.py --corpus-file "$CORPUS_FILENAME" --vocab-file "$VOCAB_FILENAME" --merge-file "$MERGE_FILENAME" --model-file "$MODEL_FILENAME" "$@"
