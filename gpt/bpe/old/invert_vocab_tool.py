...
# Usage:
#   PYTHONPATH=.  pipenv run python gpt/bpe/invert_vocab_tool.py --input-vocab-file ~/Temp/gpt/bpe/tiny_shakespeare.10000.vocab.inverted.json --output-vocab-file ~/Temp/gpt/bpe/tiny_shakespeare.10000.vocab.json
