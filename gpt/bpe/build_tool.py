...
from gpt.bpe import builder
from gpt.bpe import input_output


# Usage:
#   PYTHONPATH=.  pipenv run python gpt/bpe/build_tool.py --input-file ~/Temp/gpt/bpe/tiny_shakespeare.txt --count-merges 5000 --output-vocab-file ~/Temp/gpt/bpe/tiny_shakespeare.5000.vocab.json --output-merge-file ~/Temp/gpt/bpe/tiny_shakespeare.5000.merge.bpe
