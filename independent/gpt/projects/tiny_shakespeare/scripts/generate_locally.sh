...
PYTHONPATH=.  pipenv run python independent/gpt/projects/tiny_shakespeare/generate_tool.py --vocab-file "$VOCAB_FILENAME" --merge-file "$MERGE_FILENAME" --model-file "$MODEL_FILENAME" --prompt "$PROMPT"
