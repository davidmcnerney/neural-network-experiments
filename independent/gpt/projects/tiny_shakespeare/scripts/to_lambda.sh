...
scp ~/Temp/gpt/bpe/tinyshakespeare.txt "ubuntu@$IP_ADDRESS:project/resources"
scp ~/Temp/gpt/bpe/tinyshakespeare.5000.vocab.json "ubuntu@$IP_ADDRESS:project/resources"
scp ~/Temp/gpt/bpe/tinyshakespeare.5000.merge.bpe "ubuntu@$IP_ADDRESS:project/resources"
